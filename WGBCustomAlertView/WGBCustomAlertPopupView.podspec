#
#  Be sure to run `pod spec lint WGBCustomAlertPopupView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "wangguibin"
  # s.authors            = { "wangguibin" => "wangguibin1993@gmail.com" }
  # s.social_media_url   = "http://twitter.com/wangguibin"
